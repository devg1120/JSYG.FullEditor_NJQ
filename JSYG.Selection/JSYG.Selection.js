...
function each( obj, callback ) {
	...
	//	console.log("mouseup");
        ...
        //$doc.on("mouseup",mouseup); //GUSA
        $doc[0].addEventListener("mouseup",mouseup);
        
        //$canvas.dragEvents().on(fcts);

        //console.log($canvas.dragEvents());
        //console.log(fcts);
	  
	
        //$canvas.dragEvents().on("drag:start",fcts2['drag:start']);
        //$canvas.dragEvents()[0].addEventListener("drag:start",fcts['drag:start']);
        ...
        this.disable = function() {
            ...
            //$canvas.off(fcts2).dragEvents("destroy");
