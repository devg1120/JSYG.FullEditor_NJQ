...
*/
        //merge(this, array ? array : find(arg, context) );
/*
        if (array) {
           $.merge(this, array  );
        } else {
           $.merge(this,  find(arg,context) );
        }
*/
    ...
    JSYG.prototype.isSVGroot = function() {
        ...
        //var parent = JSYG(this[0]).parent(); //GUSA
    ...
    JSYG.prototype.offsetParent = function(arg) {
        ...
        this.each(function() {
            ...
            if ($this.isSVG()) {
                ...
                //else elmt = $.fn.offsetParent.call($this)[0];//GUSA
  ...
  */
    ...
    JSYG.prototype.getDim = function(type) {
        ...
        //console.log("-- page");   
            ...
            //x = boundingRect.left + jWin.scrollLeft() - document.documentElement.clientLeft; //GUSA
            x = boundingRect.left + jWin[0].scrollX - document.documentElement.clientLeft;  //GUSA
            //y = boundingRect.top + jWin.scrollTop() - document.documentElement.clientTop;    //GUSA
    ...
    JSYG.prototype.getShift = function(pivotX,pivotY) {
        ...
        if ($.isNumeric(pivotX) && $.isNumeric(pivotY)) return new Vect(parseFloat(pivotX),parseFloat(pivotY));
    ...
    JSYG.prototype.transfOrigin = function(x,y) {
        ...
        this.each(function() {
            ...
            //$this.data('transfOrigin',originX+' '+originY);  //GUSA
    ...
    function createFakeDragFunction($nodes) {
        ...
        return function(e) {
            ...
            function mouseupFct(e) {
                ...
                //$nodes.off("mousemove",mousemoveFct); //GUSA
                $nodes[0].removeEventListener("mousemove",mousemoveFct);

                //new JSYG(document).off("mouseup",mouseupFct); //GUSA
                new JSYG(document)[0].removeEventListener("mouseup",mouseupFct);
            }
            
            e.preventDefault();
            
            //$nodes.on("mousemove",mousemoveFct); //GUSA  
            $nodes[0].addEventListener("mousemove",mousemoveFct);
		
            //new JSYG(document).on("mouseup",mouseupFct); //GUSA
    ...
    JSYG.prototype.dragEvents = function(method) {
        ...
        //var fct = this.data("fakedrag"); //GUSA
        ...
        if (!fct && (!method || method == "enable")) {
            ...
            //this.on("mousedown",fct).data("fakedrag",fct);  //GUSA
