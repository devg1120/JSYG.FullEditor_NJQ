...
export default class FullEditor extends JSYG {
        ...
        getLayers() {
            ...
            //return new JSYG(this._getDocumentSelector()).find(".layer");  //GUSA
...
*/
        ...
        _initDrawer(drawer) {
			...
			//that.trigger("draw",that,e,this);  //GUSA
                    ...
                    //that.trigger("insert",that,e,this); //GUSA
        ...
        enableShapeDrawer(modele, _callback) {
            ...
            //frame.on("mousedown",onmousedown).data("enableDrawingShape",onmousedown);  //GUSA
        ...
        disableShapeDrawer() {
            ...
            //const fct = frame.data("enableDrawingShape");  //GUSA
        ...
        disableInsertElement() {
            const frame = new JSYG(this.zoomAndPan.innerFrame);
            //const fct = frame.data("enableInsertElement"); //GUSA
  ...
  this[0].dispatchEvent(event);
        ...
        _initShapeEditor() {
            ...
            editor.on({
                ...
                changetarget() {
     //               that.trigger("changetarget",that,editor._target);  //GUSA
  ...
  that[0].dispatchEvent(event);
		...
		/*
            let f = new JSYG(this._frameShadow)
            f.push(this._frame)
            f.attr({
                 width:dim.width,
                 height:dim.height
...
*/
        ...
        enableDropFiles() {
            ...
            //JSYG(this.zoomAndPan.innerFrame).on(fcts);  //GUSA
        ...
        loadXML(svg) {
            ...
            //container.empty().append(svg);  //GUSA
