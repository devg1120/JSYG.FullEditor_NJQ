...
export default    function ZoomAndPan(arg,opt) {
    ...
    ZoomAndPan.prototype.enable = function(opt) {
       ...
       var jSVG = new JSYG(this.node);
        ...
        //jSVG.append(exclude.list).append(innerFrame);//GUSA
        ...
        if (/%/.test(width)) {
            ...
            //JSYG(window).on("resize",majCanvas);  //GUSA
        ...
        //jSVG.data('zoomandpan',backup);  //GUSA
    ...
    ZoomAndPan.prototype.size = function(width,height,keepViewBox) {
        ...
        //innerWidth = canvas.innerWidth(), //GUSA
        innerWidth = canvas[0].clientWidth,
        //innerHeight = canvas.innerHeight(), //GUSA
    ...
    ZoomAndPan.prototype.transform = function(mtx,callback) {
        ...
        //scrollLeft = outerFrame && outerFrame.scrollLeft(), //GUSA
        scrollLeft = outerFrame && outerFrame[0].scrollLeft, 
        //scrollTop = outerFrame && outerFrame.scrollTop();   //GUSA
        ...
        if (!hidden) {
            ...
            //outerFrame.scrollLeft( Math.round(transf.translateX - translX) );  //GUSA
            outerFrame[0].scrollLeft= Math.round(transf.translateX - translX) ;  
            //outerFrame.scrollTop( Math.round(transf.translateY - translY) );   //GUSA
